...
//  hashtable_add : recherche dans la table de hachage associé à ht une clé
//    égale à celle d'adresse keyptr au sens de compar. Si une telle clé existe,
//    remplace l'adresse de la valeur correspondante par valueptr. Sinon, le
//    couple (keyptr, valueptr) est ajouté à la structure. Renvoie NULL si
//    valueptr vaut NULL ou en cas de dépassement de capacité. Renvoie sinon
//    valueptr
extern const void *hashtable_add(hashtable *ht, const void *keyptr,
    const void *valueptr);

//  hashtable_remove : recherche dans la table de hachage associé à ht une clé
//    égale à celle d'adresse keyptr au sens de compar. Si un telle clé existe,
//    retire le couple (ekeyptr, evalueptr) de la structure, où ekeyptr est
//    l'adresse de la clé trouvée et evalueptr l'adresse de la valeur
...
//  hashtable_search : recherche dans le table de hachage associé à ht une clé
...
extern const void *hashtable_value(const hashtable *ht, const void *keyptr);

//  hashtable_dispose : si *htptr ne vaut pas NULL, libère les ressources
//    allouées à la structure de donnée associée à *htptr puis affecte à *htptr
//    la valeur NULL
